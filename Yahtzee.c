...
int gameplay_menu (void)
{
	...
	do
	{
		...
		case 1: //print game rules
			...
			printf("************************************************ Generala! ************************************************\n");
			printf("\nReglas del juego:\n\n");
			printf("La tarjeta de puntuación utilizada para Yahtzee consta de dos secciones. Una sección superior y una sección inferior. Un total de\n");
			printf("trece casillas o trece combinaciones de puntuación se dividen entre las secciones. La sección superior consta\n");
			printf("de casillas que se puntúan sumando el valor de los dados que coinciden con las caras de la casilla. Si un jugador\n");
			printf("lanza cuatro 3's, entonces la puntuación colocada en la casilla de los 3's es la suma de los dados, que es 12. Una vez que un jugador ha\n");
			printf("elegido puntuar una casilla, no puede cambiarse y la combinación ya no está en juego para futuras rondas.\n");
			printf("Si la suma de las puntuaciones en la sección superior es igual o superior a 63, entonces se añaden 35 puntos más\n");
			printf("al puntaje total del jugador como bonificación. La sección inferior contiene una serie de combinaciones tipo póker.\n\n");
		...
		case 3:
			...
			break;
		default:
			printf("Escriba una respuesta valida \n");
		}
	}
